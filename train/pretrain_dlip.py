...
def main(args, config):
    ...
    datasets = [create_dataset(config['dataloader'], config, min_scale=0.2)]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='../configs/dlip_pretrain.yaml')
    parser.add_argument('--output_dir', default='output/Pretrain_dlip')
